...
void GameObject::OnContact(GameObject* contactobject, GameObject* otherobject, GameObject::ContactAction action)
{
	if (m_OnContactCallback)
		m_OnContactCallback(contactobject, otherobject, action);
}
...
void GameObject::SetOnContactCallBack(GameObject::PhysicsContactCallback callback)
{
	m_OnContactCallback = callback;
}