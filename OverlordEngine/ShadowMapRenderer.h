...
private:
	...
	DirectX::XMFLOAT4X4 CalculateVP(const DirectX::XMFLOAT3& pos, const DirectX::XMFLOAT3& dir, float nearPlane = 0.1f, float farPlane = 2500.f, bool perspective = false);
};
