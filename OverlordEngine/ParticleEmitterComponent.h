...
public:
	...
	void SetGravity(bool enabled) { m_Settings.EnableGravity = enabled; }
	void SetMass(float mass) { m_Settings.Mass = mass; }

	void Activate(bool activate) { m_IsActive = activate; }
...
protected:
	...
	DirectX::XMMATRIX CalculateViewProjection() const;
};
