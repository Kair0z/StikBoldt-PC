...
{
public:
	ControllerComponent(physx::PxMaterial* material, float radius = 2, float height = 5, float maxJumpHeight = 50.f, float maxSlope = 0.707f, std::wstring name = L"Character",
