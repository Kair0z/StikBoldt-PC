...
public:
	...
	typedef std::function<void(GameObject* contactobject, GameObject* otherobject, ContactAction action)> PhysicsContactCallback;
	...
	void OnContact(GameObject* contactobject, GameObject* otherobject, ContactAction action);
	...
	void SetOnContactCallBack(PhysicsContactCallback callback);
...
private:
	...
	PhysicsContactCallback m_OnContactCallback;
	std::wstring m_Tag;
};